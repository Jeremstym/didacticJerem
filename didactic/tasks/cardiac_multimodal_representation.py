    ...
    def __init__(
        ...
        **kwargs,
        ...
        if isinstance(self.encoder, nn.TransformerEncoder):  # Native PyTorch `TransformerEncoder`
            ...
            self.nhead = 1
            self.separate_modality = True
        elif isinstance(self.encoder, didactic.models.transformer.FT_Transformer_Alignment):  # didactic submodule `FT_Transformer_Alignment`
            self.nhead = self.hparams.model.encoder.attention_n_heads
            self.separate_modality = True
        else:
        ...
        if perform_lora:
            ...
            if self.separate_modality:
                ...
                adapter_encoder = AdapterWrapperFT_Transformer(self.encoder, lora_linar, gamma=4, lora_alpha=8)
