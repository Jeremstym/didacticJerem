...
from autogluon.core.ray.resources_calculator import (
    CpuResourceCalculator, GpuResourceCalculator,
    NonParallelGpuResourceCalculator, RayLightningCpuResourceCalculator,
    RayLightningGpuResourceCalculator, ResourceCalculatorFactory)
...
@pytest.mark.parametrize(
    "calculator_type", ["cpu", "gpu", "non_parallel_gpu", "ray_lightning_cpu", "ray_lightning_gpu"]
)
