...
class BaseTask(object):
    ...
    @classmethod
    def run_fit(
        cls, train_fn, search_space, search_strategy, scheduler_options, train_fn_kwargs=None, plot_results=False
    ):
        start_time = time.time()
        # create scheduler and schedule tasks
        scheduler = create_scheduler(
            train_fn, search_space, search_strategy, scheduler_options, train_fn_kwargs=train_fn_kwargs
        )
        scheduler.run()
        scheduler.join_jobs()
        ...
        scheduler_final = create_scheduler(
            train_fn, search_space, search_strategy, scheduler_options, train_fn_kwargs=train_fn_kwargs
        )
