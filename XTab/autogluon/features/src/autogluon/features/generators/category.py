...
import pandas as pd
from autogluon.common.features.types import (R_BOOL, R_CATEGORY, R_OBJECT,
...
class CategoryFeatureGenerator(AbstractFeatureGenerator):
    ...
    **kwargs :
    ...
    def get_default_infer_features_in_args() -> dict:
        return dict(
            valid_raw_types=[R_OBJECT, R_CATEGORY, R_BOOL], invalid_special_types=[S_DATETIME_AS_OBJECT, S_IMAGE_PATH]
        )
