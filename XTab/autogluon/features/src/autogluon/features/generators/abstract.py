...
from autogluon.common.features.infer_types import (get_type_group_map_special,
                                                   get_type_map_raw,
                                                   get_type_map_real)
    ...
    def __init__(
        ...
        if name_prefix or name_suffix:
            ...
            self._post_generators.append(
                RenameFeatureGenerator(name_prefix=name_prefix, name_suffix=name_suffix, inplace=True)
            )
