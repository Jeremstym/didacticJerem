import pandas as pd
import pytest
from autogluon.multimodal.constants import (BINARY, DATA, ENVIRONMENT, MODEL,
                                            MULTICLASS, OPTIMIZATION)
from autogluon.multimodal.data.preprocess_dataframe import \
    MultiModalFeaturePreprocessor
from autogluon.multimodal.utils import (apply_omegaconf_overrides, data_to_df,
                                        filter_search_space, get_config,
                                        is_url, parse_dotlist_conf,
