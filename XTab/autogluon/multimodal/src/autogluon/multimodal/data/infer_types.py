...
from ..constants import (AUTOMM, BINARY, CATEGORICAL, CLASSIFICATION,
                         ENTITY_GROUP, IDENTIFIER, IMAGE, IMAGE_PATH,
                         MULTICLASS, NER, NER_ANNOTATION, NULL, NUMERICAL,
                         OBJECT_DETECTION, REGRESSION, ROIS, TEXT)
