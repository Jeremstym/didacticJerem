...
class MultimodalFusionTransformer(nn.Module):
    ...
    def forward(
        ...
        multimodal_features = (
            self.fusion_transformer["cls_token"](multimodal_features)
            if self.pretrain_cls
            else self.cls_token(multimodal_features)
        )
        features = (
            self.fusion_transformer["fusion_transformer"](multimodal_features)
            if self.pretrain_cls
            else self.fusion_transformer(multimodal_features)
        )
