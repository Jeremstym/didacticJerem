...
from ..constants import (AUTOMM, CHOICES_IDS, COLUMN, COLUMN_FEATURES,
                         FEATURES, LABEL, LM_TARGET, LOGITS, MASKS,
                         TEMPLATE_LOGITS, TEXT_SEGMENT_IDS, TEXT_TOKEN_IDS,
                         TEXT_VALID_LENGTH)
        ...
        ret.update(
            {
                ...
                FEATURES: encoder_hidden_states_or[:, 0, :],  # needed to ensure compatibility to encoder-only pipelines
            }
        )
